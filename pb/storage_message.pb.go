...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=golanggRPC.Storage_Driver" json:"driver,omitempty"`
...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x67, 0x52, 0x50, 0x43, 0x1a, 0x1a, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x67, 0x52, 0x50, 0x43, 0x2e, 0x53,
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x67, 0x6f, 0x6c, 0x61, 0x6e, 0x67, 0x67, 0x52,
	0x50, 0x43, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72,
...
var file_proto_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: golanggRPC.Storage.Driver
	(*Storage)(nil),     // 1: golanggRPC.Storage
	(*Memory)(nil),      // 2: golanggRPC.Memory
}
var file_proto_storage_message_proto_depIdxs = []int32{
	0, // 0: golanggRPC.Storage.driver:type_name -> golanggRPC.Storage.Driver
	2, // 1: golanggRPC.Storage.memory:type_name -> golanggRPC.Memory
